...
from flask import redirect, jsonify, request, render_template, session, url_for
...
def authorize(*args, **kwargs):
    ...
    if request.method == 'GET':
        ...
        if not user:
            ...
            return render_template('signin_oauth.html', form=form, **kwargs)
        else:
            return True
        ...
        print('ps', user_by_username.ps)
        if user_by_username and password == user_by_username.ps:
            return True
